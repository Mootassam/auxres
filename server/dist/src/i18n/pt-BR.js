...
const ptBR = {
    ...
    auth: {
        ...
        passwordReset: {
            invalidToken: 'Link de redefinição de senha é inválido ou expirou',
            error: `Email não reconhecido`,
        },
        emailAddressVerificationEmail: {
            invalidToken: 'Link de verificação de email é inválido ou expirou.',
            error: `Email não reconhecido.`,
    ...
    tenant: {
        exists: 'Já existe um workspace neste aplicativo.',
        url: {
    ...
    importer: {
        errors: {
            ...
            invalidFileUpload: 'Arquivo inválido. Certifique-se de estar usando a última versão do template.',
