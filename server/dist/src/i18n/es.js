...
const es = {
    ...
    auth: {
        ...
        emailAddressVerificationEmail: {
            invalidToken: 'El enlace de verificación de email no es válido o ha expirado.',
            error: `Email no reconocido.`,
    ...
    tenant: {
        exists: 'Ya existe un espacio de trabajo en esta aplicación.',
        url: {
    ...
    importer: {
        errors: {
            ...
            invalidFileUpload: 'Archivo no válido. Asegúrate de estar usando la última versión de la plantilla.',
