...
const de = {
    ...
    auth: {
        ...
        passwordReset: {
            invalidToken: 'Passwort-Reset-Link ist ungültig oder abgelaufen',
            error: `E-Mail nicht erkannt`,
        },
        emailAddressVerificationEmail: {
            invalidToken: 'E-Mail-Bestätigungslink ist ungültig oder abgelaufen.',
            error: `E-Mail nicht erkannt.`,
    ...
    tenant: {
        exists: 'Es existiert bereits ein Arbeitsbereich in dieser Anwendung.',
        url: {
