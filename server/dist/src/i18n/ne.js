...
const ne = {
    ...
    auth: {
        ...
        passwordReset: {
            invalidToken: 'पासवर्ड रिसेट लिङ्क अवैध वा म्याद सकिएको छ',
            error: `इमेल चिन्न सकिएन`,
        },
        emailAddressVerificationEmail: {
            invalidToken: 'इमेल सत्यापन लिङ्क अवैध वा म्याद सकिएको छ।',
            error: `इमेल चिन्न सकिएन।`,
    ...
    user: {
        errors: {
            userAlreadyExists: 'यस इमेलसँग पहिले नै प्रयोगकर्ता अवस्थित छ।',
    ...
    tenant: {
        exists: 'यस अनुप्रयोगमा पहिले नै कार्यक्षेत्र अवस्थित छ।',
        url: {
    ...
    importer: {
        errors: {
            ...
            invalidFileExcel: 'एक्सेल फाइलहरू मात्र अनुमति छ (.xlsx)',
            invalidFileUpload: 'अवैध फाइल। निश्चित गर्नुहोस् कि तपाईं टेम्पलेटको नवीनतम संस्करण प्रयोग गर्दै हुनुहुन्छ।',
