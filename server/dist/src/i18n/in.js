...
const In = {
    ...
    auth: {
        ...
        passwordReset: {
            invalidToken: 'पासवर्ड रीसेट लिंक अमान्य है या इसकी अवधि समाप्त हो गई है',
            error: `ईमेल अज्ञात है`,
        },
        emailAddressVerificationEmail: {
            invalidToken: 'ईमेल सत्यापन लिंक अमान्य है या इसकी अवधि समाप्त हो गई है।',
            error: `ईमेल अज्ञात है।`,
    ...
    user: {
        errors: {
            userAlreadyExists: 'इस ईमेल के साथ पहले से ही एक उपयोगकर्ता मौजूद है।',
    ...
    tenant: {
        exists: 'इस एप्लिकेशन में पहले से ही एक कार्यक्षेत्र मौजूद है।',
        url: {
    ...
    importer: {
        errors: {
            ...
            invalidFileExcel: 'केवल एक्सेल फ़ाइलें (.xlsx) की अनुमति है',
            invalidFileUpload: 'अमान्य फ़ाइल। सुनिश्चित करें कि आप टेम्पलेट के नवीनतम संस्करण का उपयोग कर रहे हैं।',
