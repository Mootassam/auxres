...
const tr = {
    ...
    auth: {
        ...
        emailAddressVerificationEmail: {
            invalidToken: 'E-posta doğrulama bağlantısı geçersiz veya süresi dolmuş.',
            error: `E-posta tanınmadı.`,
    ...
    user: {
        errors: {
            userAlreadyExists: 'Bu e-posta ile zaten bir kullanıcı mevcut.',
    ...
    preview: {
        error: 'Üzgünüz, bu işleme önizleme modunda izin verilmiyor.',
    },
};
exports.default = tr;
