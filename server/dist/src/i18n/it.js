...
const it = {
    ...
    auth: {
        ...
        passwordReset: {
            invalidToken: 'Il link di reimpostazione password non è valido o è scaduto',
            error: `Email non riconosciuta`,
        },
        emailAddressVerificationEmail: {
            invalidToken: 'Il link di verifica email non è valido o è scaduto.',
            error: `Email non riconosciuta.`,
    ...
    tenant: {
        exists: 'Esiste già un workspace su questa applicazione.',
        url: {
    ...
    importer: {
        errors: {
            ...
            invalidFileExcel: 'Sono consentiti solo file Excel (.xlsx)',
            invalidFileUpload: 'File non valido. Assicurati di utilizzare l\'ultima versione del template.',
    ...
    preview: {
        error: 'Spiacenti, questa operazione non è consentita in modalità anteprima.',
    },
};
exports.default = it;
