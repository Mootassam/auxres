...
const depositNetwork_1 = __importDefault(require("../models/depositNetwork"));
class DepositRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            const currentUser = mongooseRepository_1.default.getCurrentUser(options);
            const [record] = yield depositNetwork_1.default(options.database).create([
    ...
    static update(id, data, io, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(depositNetwork_1.default(options.database).findById(id), options);
            if (!record || String(record.tenant) !== String(currentTenant.id)) {
                throw new Error404_1.default();
            }
            yield depositNetwork_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { auditor: mongooseRepository_1.default.getCurrentUser(options).id, updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static updateStatus(id, data, io, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield depositNetwork_1.default(options.database).updateOne({ _id: id }, {
                $set: {
                    name: data.name,
                    wallet: data.wallet,
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield depositNetwork_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(depositNetwork_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(depositNetwork_1.default(options.database)
                .findById(id)
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = "" }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield depositNetwork_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
                .populate("createdBy");
            const count = yield depositNetwork_1.default(options.database).countDocuments(criteria);
    ...
    static findAllAutocomplete(search, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield depositNetwork_1.default(options.database)
                .find(criteria)
                .limit(limitEscaped)
                .sort(sort);
    ...
    static _createAuditLog(action, id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //   {
            //     entityName: DepositNetwork(options.database).modelName,
            //     entityId: id,
            //     action,
            //     values: data,
            //   },
...
//# sourceMappingURL=depositNetworkRepository.js.map