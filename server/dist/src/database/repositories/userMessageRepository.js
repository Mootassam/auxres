...
class UserMessageRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield userMessage_1.default(options.database).create([
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(userMessage_1.default(options.database).findById(id), options);
            if (!record || String(record.tenant) !== String(currentTenant.id)) {
                throw new Error404_1.default();
            }
            yield userMessage_1.default(options.database).updateOne({ _id: id }, Object.assign(Object.assign({}, data), { updatedBy: mongooseRepository_1.default.getCurrentUser(options).id }), options);
    ...
    static destroy(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield userMessage_1.default(options.database).deleteOne({ _id: id }, options);
    ...
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(userMessage_1.default(options.database).countDocuments(Object.assign(Object.assign({}, filter), { tenant: currentTenant.id })), options);
        });
    }
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(userMessage_1.default(options.database).findById(id).populate("user"), options);
            if (!record || String(record.tenant) !== String(currentTenant.id)) {
                throw new Error404_1.default();
            }
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = "" }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield userMessage_1.default(options.database)
                .find(criteria)
                .skip(skip)
                .limit(limitEscaped)
                .sort(sort)
                .populate("user");
            const count = yield userMessage_1.default(options.database).countDocuments(criteria);
    ...
    static findAllAutocomplete(search, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield userMessage_1.default(options.database)
                .find(criteria)
                .limit(limitEscaped)
                .sort(sort);
...
//# sourceMappingURL=userMessageRepository.js.map