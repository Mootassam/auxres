...
class NotificationRepository {
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [record] = yield notification_2.default(options.database).create([
    ...
    static update(id, io, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield notification_1.default(options.database).updateOne({ _id: id }, {
    ...
    static unread(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            return mongooseRepository_1.default.wrapWithSessionIfExists(notification_1.default(options.database).countDocuments({
    ...
    static unreadSummary(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depositQuery = deposit_1.default(options.database).countDocuments({
                tenant: currentTenant.id,
                status: "pending",
            });
            const withdrawQuery = withdraw_1.default(options.database).countDocuments({
                tenant: currentTenant.id,
                status: "pending",
            });
            const kycQuery = kyc_1.default(options.database).countDocuments({
                tenant: currentTenant.id,
                status: "pending",
            });
            const futuresQuery = futures_1.default(options.database).countDocuments({
                tenant: currentTenant.id,
                finalized: false,
            });
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTenant = mongooseRepository_1.default.getCurrentTenant(options);
            let record = yield mongooseRepository_1.default.wrapWithSessionIfExists(notification_1.default(options.database).findById(id).populate("userId"), options);
            if (!record || String(record.tenant) !== String(currentTenant.id)) {
                throw new Error404_1.default();
            }
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = "" }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let rows = yield notification_1.default(options.database)
                ...
                .sort(sort)
                .populate("userId");
            const count = yield notification_1.default(options.database).countDocuments({
