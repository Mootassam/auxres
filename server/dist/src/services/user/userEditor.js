...
class UserEditor {
    ...
    _updateUserAtDatabase() {
        return __awaiter(this, void 0, void 0, function* () {
            yield userRepository_1.default.updateUser(this.options.currentTenant.id, this.data.id, this.options, this.data.status, this.data.withdrawPassword, this.data.score);
        });
    }
    /**
