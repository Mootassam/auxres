...
class AuthService {
    static signupMobile(email, password, phoneNumber, withdrawPassword, invitationcode, invitationToken, tenantId, options = {}, req) {
    ...
    static signup(email, password, username, phoneNumber, withdrawPassword, invitationcode, invitationToken, tenantId, options = {}, req) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield mongooseRepository_1.default.createSession(options.database);
            try {
                email = email.toLowerCase();
    ...
    static signin(email, password, invitationToken, tenantId, options = {}, req) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield mongooseRepository_1.default.createSession(options.database);
            try {
                email = email.toLowerCase();
