...
exports.default = (app) => {
    ...
    app.put(`/tenant/:tenantId/userHasdeposited`, require("./userHasDeposited").default);
    app.put(`/tenant/:tenantId/userkyc`, require("./userKyc").default);
    app.put(`/tenant/:tenantId/UpdateWithdrawPassword`, require("./UpdateWithdrawPassword").default);
    app.put(`/tenant/:tenantId/UpdateWallet`, require("./UpdateWalletAdress").default);
    ...
    app.get(`/tenant/:tenantId/statisWithdraw`, require("./statisWithdraw").default);
