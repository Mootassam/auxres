...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = yield authService_1.default.signupMobile(req.body.email, req.body.password, req.body.phoneNumber, req.body.withdrawPassword, req.body.invitationcode, req.body.invitationToken, req.body.tenantId, req, req);
