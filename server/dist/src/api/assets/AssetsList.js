...
const assetsServices_1 = __importDefault(require("../../services/assetsServices"));
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // new PermissionChecker(req).validateHas(Permissions.values.categoryRead);  
        const payload = yield new assetsServices_1.default(req).findAndCountAll(req.body.data);
