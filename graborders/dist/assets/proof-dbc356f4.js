...
`;function lt(e){return l.jsx(gr,{children:l.jsxs("div",{className:"modal",children:[l.jsx("span",{className:"close",onClick:e.onClose,children:"×"}),l.jsx("img",{className:"modal-content",src:e.src,alt:e.alt})]})})}lt.propTypes={src:W.string.isRequired,alt:W.string.isRequired,onClose:W.func.isRequired};function $e(e){const[r,t]=ne.useState(!1),[a,n]=ne.useState(null),s=ne.useRef(),i=()=>{const{value:w}=e;return w?Array.isArray(w)?w:[w]:[]},u=w=>{const g=i().filter(y=>y.id!==w);e.onChange(g)},m=async w=>{try{const g=w.target.files;if(!g||!g.length)return;let y=g[0];Ye.validate(y,{storage:e.storage,image:!0}),t(!0),y=await Ye.upload(y,{storage:e.storage,image:!0}),s!=null&&s.current&&(s.current.value=null),t(!1),e.onChange([y])}catch(g){s!=null&&s.current&&(s.current.value=null),console.error(g),t(!1),mt.showMessage(g)}},p=w=>{n({src:w.downloadUrl,alt:w.name})},A=()=>{n(null)},{readonly:N}=e,O=l.jsx("label",{children:l.jsxs("div",{className:"upload-area",children:[l.jsx("div",{className:"upload-icon",children:l.jsx("i",{className:"fas fa-cloud-upload-alt"})}),l.jsx("div",{className:"upload-text",children:e.text}),l.jsx("div",{className:"upload-subtext",children:"JPG, PNG or PDF, max 5MB"}),l.jsx("input",{style:{display:"none"},disabled:r||N,accept:"image/*",type:"file",onChange:m,ref:s})]})});return l.jsxs(mr,{children:[N||i().length>0?null:O,i().length>0&&l.jsx("div",{className:"upload-card",children:i().length===0?O:i().map(w=>l.jsxs("div",{className:"uploaded-box",children:[l.jsx("img",{alt:w.name,src:w.downloadUrl,className:"uploaded-img"}),l.jsxs("div",{className:"img-buttons",children:[l.jsx("button",{type:"button",className:"btn btn-link",onClick:()=>p(w),children:l.jsx("i",{className:"fas fa-search"})}),!N&&l.jsx("button",{type:"button",className:"btn btn-link ml-2",onClick:()=>u(w.id),children:l.jsx("i",{className:"fas fa-times"})})]})]},w.id||w.name))}),a&&l.jsx(lt,{src:a.src,alt:a.alt,onClose:A})]})}$e.propTypes={readonly:W.bool,storage:W.object,value:W.any,onChange:W.func,text:W.string};$e.defaultProps={text:"Upload"};function be(e){const{label:r,name:t,text:a,hint:n,storage:s,max:i,required:u,externalErrorMessage:m}=e,{errors:p,formState:{touched:A,isSubmitted:N},setValue:O,watch:w,register:g}=wt();ne.useEffect(()=>{g({name:t})},[g,t]);const y=kt.errorMessage(t,p,A,N,m);return l.jsxs("div",{className:"file-upload",children:[!!r&&l.jsx("label",{className:`input-label ${u?"required":null}`,htmlFor:t,children:r}),l.jsx($e,{storage:s,value:w(t),onChange:x=>{O(t,x,{shouldValidate:!0,shouldDirty:!0}),e.onChange&&e.onChange(x)},text:a,max:i}),l.jsx("div",{className:"invalid-feedback",children:y}),!!n&&l.jsx("small",{className:"form-text text-muted",children:n})]})}be.defaultProps={max:void 0,required:!1};be.propTypes={storage:W.object.isRequired,max:W.number,required:W.bool,name:W.string.isRequired,label:W.string,hint:W.string,formItemProps:W.object,text:W.string};const xr={status:["pending","canceled","success"],type:["withdraw","deposit"]},br=e=>vt().shape({user:oe.relationToOne(j("entities.vip.fields.title"),{}),Documenttype:oe.string(j("pages.proof.fields.documentType")),realname:oe.string(j("pages.proof.fields.fullName"),{required:!0}),idnumer:oe.string(j("pages.proof.fields.documentNumber"),{required:!0}),address:oe.string(j("pages.proof.fields.address"),{required:!0}),front:oe.images(j("pages.proof.fields.frontSide"),{required:!0}),back:e==="passport"?oe.images(j("pages.proof.fields.backSide")):oe.images(j("pages.proof.fields.backSide"),{required:!0}),selfie:oe.images(j("pages.proof.fields.selfie"),{required:!0}),status:oe.enumerator(j("entities.transaction.fields.status"),{options:xr.status})});function Cr(){const[e,r]=ne.useState("passport"),t=gt(xt.selectCurrentUser),a=Nt(),n=ne.useMemo(()=>br(e),[e]),s=St({resolver:Ct.yupResolver(n),mode:"all",defaultValues:{user:t||[],Documenttype:e,realname:"",idnumer:"",address:"",front:[],back:[],selfie:[],status:"pending"}}),i=p=>{const A={...p,user:t,Documenttype:e};e==="passport"&&(A.back=[]),a(yt.doCreate(A))},u=p=>{r(p),p==="passport"&&s.setValue("back",[])},m=[{value:"passport",label:j("pages.proof.documentTypes.passport"),icon:"fas fa-passport"},{value:"idCard",label:j("pages.proof.documentTypes.idCard"),icon:"fas fa-id-card"},{value:"driversLicense",label:j("pages.proof.documentTypes.driversLicense"),icon:"fas fa-id-card-alt"}];return l.jsxs("div",{className:"proof-container",children:[l.jsx("div",{className:"header",children:l.jsxs("div",{className:"nav-bar",children:[l.jsx(bt,{to:"/profile",className:"back-arrow",children:l.jsx("i",{className:"fas fa-arrow-left"})}),l.jsx("div",{className:"page-title",children:j("pages.proof.title")})]})}),l.jsxs("div",{className:"content-card",children:[l.jsxs("div",{className:"instructions",children:[l.jsx("i",{className:"fas fa-info-circle"}),j("pages.proof.instructions")]}),l.jsx(At,{...s,children:l.jsxs("form",{onSubmit:s.handleSubmit(i),children:[l.jsxs("div",{className:"form-section",children:[l.jsx("div",{className:"section-title",children:j("pages.proof.sections.documentInfo")}),l.jsxs("div",{className:"document-type-section",children:[l.jsxs("div",{className:"input-label",children:[j("pages.proof.fields.documentType")," ",l.jsx("span",{className:"required",children:"*"})]}),l.jsx("div",{className:"document-type-options",children:m.map(p=>l.jsxs("div",{className:`document-option ${p.value===e?"selected":""}`,onClick:()=>u(p.value),children:[l.jsx("i",{className:`${p.icon} document-icon`}),l.jsx("span",{className:"document-text",children:p.label})]},p.value))})]}),l.jsx("div",{className:"input-group",children:l.jsx(Pe,{className:"form-input",name:"realname",label:j("pages.proof.fields.fullName"),placeholder:j("pages.proof.placeholders.fullName")})}),l.jsx("div",{className:"input-group",children:l.jsx(Pe,{className:"form-input",name:"idnumer",label:j("pages.proof.fields.documentNumber"),placeholder:j("pages.proof.placeholders.documentNumber")})}),l.jsx("div",{className:"input-group",children:l.jsx(Pe,{className:"form-input",name:"address",label:j("pages.proof.fields.address"),placeholder:j("pages.proof.placeholders.address")})})]}),l.jsxs("div",{className:"form-section",children:[l.jsx("div",{className:"section-title",children:j("pages.proof.sections.documentUpload")}),l.jsx("div",{className:"upload-section",children:l.jsx(be,{name:"front",label:j("pages.proof.fields.frontSide"),storage:Ee.values.categoryPhoto,text:j("pages.proof.uploadTexts.frontSide"),max:2})}),e!=="passport"&&l.jsx("div",{className:"upload-section",children:l.jsx(be,{name:"back",label:j("pages.proof.fields.backSide"),storage:Ee.values.categoryPhoto,text:j("pages.proof.uploadTexts.backSide"),max:2})}),l.jsx("div",{className:"upload-section",children:l.jsx(be,{name:"selfie",label:j("pages.proof.fields.selfie"),storage:Ee.values.categoryPhoto,text:j("pages.proof.uploadTexts.selfie"),max:2})})]}),l.jsxs("div",{className:"security-note",children:[l.jsxs("div",{className:"security-header",children:[l.jsx("i",{className:"fas fa-shield-alt"})," ",j("pages.proof.security.title")]}),l.jsx("div",{className:"security-text",children:j("pages.proof.security.text")})]}),l.jsx("button",{type:"submit",className:"submit-button",children:j("pages.proof.buttons.validateDocuments")})]})})]}),l.jsx("style",{children:`
        * {
          margin: 0;
          padding: 0;
