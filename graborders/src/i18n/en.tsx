  ...
  pages: {
    ...
    privacy: {
      ...
      personalData: {
        ...
        examples: "Examples include: name, AureX ID, email address, location data, transaction history, and device information."
      },
      dataUsage: {
      ...
      dataSharing: {
        title: "Data Sharing",
        content: "We may share your data with other AureX entities or trusted third parties under strict contractual safeguards, only when necessary for the purposes outlined in our Privacy Notice."
      },
      cookies: {
    ...
    termsOfUse: {
      title: "Terms of Use",
      hero: {
        title: "AureX Terms of Use"
      },
      agreement: {
        title: "Agreement",
        content: "This is a binding agreement between you (the user) and AureX. It covers all AureX Services you access or use."
      },
      riskWarning: {
        title: "Risk Warning",
        content: "Digital assets are volatile and can fluctuate significantly in value. AureX is not a broker, financial advisor, or investment advisor. You must conduct your own due diligence before making any financial decisions."
      },
      aboutServices: {
        title: "About Our Services",
        aboutAureX: {
          title: "About AureX",
          content: "AureX provides digital asset exchange, custody services, and related financial services through our platform."
        },
        eligibility: {
          title: "Eligibility",
        ...
        communication: {
          title: "Communication",
          content: "You must keep your contact information updated. AureX will contact you via email, SMS, or phone regarding your account and our services."
        }
      },
      services: {
        title: "Our Services",
        servicesProvided: {
          ...
          content: "AureX offers digital asset trading, secure custody solutions, and customer support through both automated bots and human representatives. User chat functionality is also available."
        },
        fees: {
          title: "Fees",
      ...
      transactions: {
        ...
        transactionCancellation: {
          ...
          content: "AureX reserves the right to cancel or amend transactions in cases of suspected fraud, errors, or violations of these Terms."
        },
      ...
      digitalAssets: {
        ...
        supportedAssets: {
          ...
          content: "You may only transact with digital assets explicitly supported by AureX. Attempting to deposit unsupported assets may result in permanent loss."
        },
        forksAirdrops: {
          title: "Forks & Airdrops",
          content: "AureX does not guarantee support for blockchain forks, airdrops, or other similar events. Support decisions are made at our sole discretion."
        }
      },
      accountSecurity: {
      ...
      privacy: {
        title: "Privacy",
        content: "Your privacy is governed by the AureX Privacy Notice, which explains how we collect, use, and protect your personal information."
      },
      termination: {
        title: "Account Termination",
        terminationSuspension: {
          title: "Termination/Suspension",
          content: "AureX may restrict, suspend, or terminate accounts for fraud, law violations, suspicious activity, or Terms violations. Users may close accounts unless frozen or dormant."
        }
      },
      prohibitedUse: {
        title: "Prohibited Use",
        content: "You may not use AureX services for fraud, market manipulation, illegal activities, unauthorized access, or any purpose that violates applicable laws or these Terms."
      },
      liability: {
        title: "Liability & Intellectual Property",
        liability: {
          title: "Liability",
          content: "AureX is not responsible for losses except in cases of proven gross negligence or fraud. We are not liable for market fluctuations, technical issues, or third-party actions."
        },
        intellectualProperty: {
          title: "Intellectual Property",
          content: "AureX retains all intellectual property rights to our platform, technology, and branding. Users receive a limited license to use our services as outlined in these Terms."
        },
        indemnity: {
          title: "Indemnity",
          content: "You agree to indemnify and hold AureX harmless against any claims, losses, or damages resulting from your misuse of our services or violation of these Terms."
        }
      },
      importantNotice: {
        title: "Important Notice",
        content: "By using AureX services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use. If you do not agree, you must discontinue use of our services immediately."
      },
      actionCards: {
        security: {
          title: "Security",
    ...
    invitation: {
      ...
      description: "Invite friends to join AureX and earn rewards when they sign up and start trading.",
    ...
    faq: {
      ...
      hero: {
        ...
        subtitle: "Find answers to common questions about using AureX"
      },
      search: {
      ...
      steps: {
        goToWebsite: "Go to https://AureX-exchange.com",
      ...
      benefits: {
        title: "Why Choose AureX Futures?",
